...
subTitle: A revival of the fabled FiveThirtyEight Elo ratings, enhanced with machine learning
tags:
  - machine learning
---
...
The code to gather the data, analyze with ML.NET and F#, and generate the Elo+ ratings is a part of an app I am building called Fastbreak that offers daily sports analytics. To see the tech in action, pull down [the code for the `Fastbreak.Research.Cli`](https://github.com/joe307bad/fastbreak/tree/89bbd4d7e34a3171848c0b434935d1f688554216/server/src/Fastbreak.Research.Cli) and run this command:
<br />
```
dotnet run --project src/Fastbreak.Research.Cli -- 01-generate-elo-plus -f test.csv -m report.md
```
</Sticky>
