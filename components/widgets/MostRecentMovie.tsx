...
export default function MostRecentMovie({title, description, date, rating = undefined, nowrap = false}) {
        ...
        <>
            ...
            >
                ...
                <div className="inline-flex items-center w-full">
                    ...
                    <p
                        style={{fontFamily: "Roboto", borderColor: "#4ce0b3"}}
                        className={`font-light p-1 text-base ${rating ? 'border-r-2' : ''} ${nowrap ? 'overflow-hidden truncate' : ''} border-l-2 flex-1 text-left`}
                    >
                        {description}
                    </p>
                    {rating ? <ul className="flex justify-center pr-1 pl-1">
                        <li>
                            <svg
                                style={{color: "#4ce0b3"}}
                                aria-hidden="true"
