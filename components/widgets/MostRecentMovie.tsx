export default function MostRecentMovie({ title, description, date }) {
  return (
    <div
    ...
    >
      ...
      <div className="inline-flex items-center w-full">
        <p
          ...
          className="text-bold p-1 text-base border-r-2"
        >
          {date}
        </p>
        <p
          style={{ fontFamily: "Roboto", borderColor: "#4ce0b3" }}
          className="font-light p-1 text-base border-r-2 flex-1 text-left"
        >
          {description}
        </p>
