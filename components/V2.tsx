  ...
  return (
    <Page>
      ...
      <h3>
        ...
        training for half marathons, pondering the mysteries of cosmology,
        working on side projects, and relaxing with TV shows and movies.
        <br />
        <br />
      </h3>
      ...
      <div className="border-l-[5px] border-l-[#f26130] p-1 pl-5">
        <div className="flex">
          <h3 className="text-lg">void</h3>
          <span className="pl-5">
            <TagsList tags={["closed alpha"]} />
          </span>
        </div>
        <br />
        <p>
          Offline-first, multiplayer strategy wargame focused on conquest and
          interactive fiction
        </p>
        <br />
        <div className="flex">
          <div>◆</div>
          <p className="pl-2">
            Built with: Effect, TypeScript, React, React Native, Nx, Three.js,
            React Three Fiber, NestJS, WatermelonDB, MongoDB
          </p>
        </div>
        <div className="flex">
          <div>◆</div>
