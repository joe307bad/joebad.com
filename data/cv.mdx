...
<Position>
    ## <strong>Senior Software Engineer at SoftWriters</strong>
    ### March 2024 - present
    <br />
    #### <strong>Links</strong>
...
<br />
<Position>
    ## <strong>Front-End Engineer II at Amazon Web Services (AWS)</strong>
    ### May 2022 - March 2024
    <br/>
    ...
    that provides visualizations and insights into web service logs running at a global scale. I've implemented
    accessible and internationalized features that provided real time data to millions of users. As the world leader in
    monitoring solutions, this frontend team has to make critical considerations for thousands of different user devices
    and internet capability variations. Also, I've collaborated with service teams on developing high quality, high
    ...
    <br/>
    #### <span id="aws-accomplishments"><strong>Accomplishments</strong></span>
    <br/>
    <Accomplishment>
        - <strong>November 2023</strong> - Contributed to the planning, development, and launch of <a target="_blank"
    ...
    <br/>
    <Accomplishment>
        - <strong>August 2023</strong> - Lead the CWL team in migrating our entire API layer from one legacy backend
...
<Position>
    ## <strong>Senior Software Engineer, Team Lead at Homee, Inc.</strong>
...
<br/>
<Position>
    ## <strong>Senior Software Engineer at Proofpoint</strong>
...
<br/>
<Position>
    ## <strong>Software Engineer at Idelic</strong>
...
<br/>
<Position>
    ## <strong>Software Engineer at PSI</strong>
...
<Position>
    ## <strong>Senior Visual Developer at Brunner</strong>
...
<br/>
<Position>
    ## <strong>Lead Developer at YellowBridge Interactive</strong>
...
<br/>
<Position>
    ## <strong>Web Application Developer at American Textile Company</strong>
